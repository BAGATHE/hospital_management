...
class HospitalRound(models.Model):
    ...
    state = fields.Selection(string="State round",selection=[('planned', 'In comming'),('done', 'Done')  ],default='planned')
    ...
    next_round_date = fields.Date(string='Next Round Date')
    description_next_round = fields.Text(string='Description Next Round')
